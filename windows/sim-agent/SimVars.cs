...
//   [Q1] RESOLVED — GEAR TOTAL PCT EXTENDED as "Percent" really is 0..100.
//        Read simultaneously as "Percent" and "Percent Over 100" against a live
//        session it returned 1.0000 and 0.0100, exactly 100x apart, so the unit
//        is honoured. Still worth re-confirming mid-cycle on a retractable
//        airframe: the reading above came from a fixed-gear helicopter.
...
internal static class SimVars
{
    ...
    public static readonly (string Name, string Unit)[] StateVars =
    {
        ...
        ("GEAR TOTAL PCT EXTENDED",        "Percent"),          // [Q1]
